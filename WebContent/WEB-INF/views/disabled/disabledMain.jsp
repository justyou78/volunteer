...
<body>
	...
	<p style="margin-top: -12px">
		사용한 데이터를 보시려면 <em class="link"> <a
			href="/volunteer/web/data/chicken.json" target="_blank">여기를
				클릭하세요!</a>
		</em>
	</p>
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=494e02c4821bde94e76161ca7fd542b2&libraries=clusterer"></script>
	...
	<script>
		...
		$.get("/volunteer/web/data/chicken.json", function(data) {
